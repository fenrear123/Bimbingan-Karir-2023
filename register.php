          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="main/img/Disperakim.png" width="100px" height="100px" alt="logo">
              </div>
              ...
              <form method="POST" class="pt-3">
                ...
                <div class="mt-3">
                  <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="http://localhost/KP/">BATAL</a>
                </div>
