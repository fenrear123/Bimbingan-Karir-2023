          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="main/img/Aksara.png" width="100px" height="100px" alt="logo">
              </div>
              <h4>LOGIN PEGAWAI</h4>
              <form method="POST" class="pt-3">
                <div class="form-group">
                  <select name="hak_akses" id="" class="form-control text-uppercase">
                    ...
                    <?php
                    $SQL = "SELECT * FROM data_user WHERE hak_akses='Admin' or hak_akses='Dokter'";
                ...
                <div class="mb-2">
                  <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="http://localhost/Poli/">BATAL</a>
                </div>
